...
#define TAMC200_VENDOR_ID    0x10B5	/* 4277  TEWS vendor ID */
#define TAMC200_DEVICE_ID    0x9030	/* 36912 IP carrier board device ID */
#define TAMC200_SUBVENDOR_ID 0x1498	/* 5272  TEWS vendor ID */
#define TAMC200_SUBDEVICE_ID 0x80C8	/* 32968 IP carrier board device ID */

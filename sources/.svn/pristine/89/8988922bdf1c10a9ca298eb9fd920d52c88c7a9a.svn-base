...
typedef struct Pci_gen_dev
{
	ZnDrv_gen				m_DrvStuff;
	
	void __iomem *			m_memory_base[NUMBER_OF_BARS];
	loff_t					m_rw_off[NUMBER_OF_BARS];
	u32						m_mem_base[NUMBER_OF_BARS];
	u32						m_mem_base_end[NUMBER_OF_BARS];
	u32						m_mem_base_flag[NUMBER_OF_BARS];
	
	int						m_dev_sts : 1;
	int						m_nCreateInsideBigStruct : 1;
	int						m_slot_num : 5;

            ...
            struct file_operations *pciedev_fops, pciedev_cdev *pciedev_cdev_p, char *dev_name, int * brd_num)
{
    ...
    * brd_num = m_brdNum;
	...
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base0 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base[0];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base1 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base[1];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base2 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base[2];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base3 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base[3];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base4 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base[4];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base5 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base[5];

	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base0_end = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_end[0];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base1_end = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_end[1];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base2_end = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_end[2];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base3_end = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_end[3];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base4_end = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_end[4];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base5_end = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_end[5];

	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base0_flag = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_flag[0];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base1_flag = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_flag[1];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base2_flag = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_flag[2];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base3_flag = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_flag[3];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base4_flag = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_flag[4];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base5_flag = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->mem_base_flag[5];

	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off0 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off[0];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off1 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off[1];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off2 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off[2];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off3 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off[3];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off4 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off[4];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off5 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->rw_off[5];

	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base0 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base[0];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base1 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base[1];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base2 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base[2];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base3 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base[3];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base4 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base[4];
	pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base5 = pciedev_cdev_p->pciedev_dev_m[m_brdNum]->memmory_base[5];
